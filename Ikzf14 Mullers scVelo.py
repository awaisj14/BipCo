...
sc.pl.umap(adata, color=['Nrl'])

sc.pl.umap(Ikzf14, color='leiden', legend_fontsize='12', title='Ikzf1/4', frameon=False, size=15, save='Ikzf14onside.pdf')
    Ikzf14 = adata
new_cluster_names = [
    'Müller-1', 'Rods',
    'BC-like 1','BC-like 2', 'Microglia-1', 'Cones', 'BC-like 3', 'Müller-2', 'BC-like 4', 'BC-like 5', 'Endothelial cells-1', 'Endothelial cells-2', 'Pericytes', 'Müller-3']
...
scv.pl.velocity(adata, 'Ikzf1', save='Ikzf1Thrbvelo.pdf')
