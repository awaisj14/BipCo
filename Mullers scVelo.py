...
adata = scv.read('Ikzf14.loom', cache=True)
...
sc.pl.umap(adata, color=['Pax6', 'Sag', 'Rxrg'])
sc.pl.scatter(adata,color=['Pax6', 'Sag', 'Rxrg'],legend_loc='none',color_map=mpl.cm.Reds,size=10,basis='umap')
...
scv.pl.velocity_embedding(adata, arrow_length=5, arrow_size=1, dpi=300)
...
scv.pl.velocity(adata, 'Casz1')
scv.pl.scatter(adata, 'Casz1', color=['leiden', 'velocity'],
